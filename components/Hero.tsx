            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className='max-w-[89px] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
                        {/*Dynamic  Magic with Unreal Engine*/}
                    </h2>

                    <TextGenerateEffect className='text-center text-[40px] md:text-5xl lg:text-6xl' words='Transforming creative concepts into immersive gaming experiences.' />

                    <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                        Hi, I&apos;m Laxmipathi, an indie game designer/developer based in India.
                    </p>

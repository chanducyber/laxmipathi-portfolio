    ...
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                ...
                <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase-2" />} description="Once we agree on the plan, I'll start designing and coding, keeping you updated every step of the way.">
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card title="Development & Launch" icon={<AceternityIcon order="Phase-3" />} description="Based on the design, I'll translate everything into functional code, building the game from the ground up.">
                    <CanvasRevealEffect
                        animationSpeed={3}
